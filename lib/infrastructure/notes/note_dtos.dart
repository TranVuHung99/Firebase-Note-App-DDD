...
abstract class NoteDto implements _$NoteDto {
  ...
  factory NoteDto({
    ...
    @SeverTimeStampConverter() required dynamic serverTimeStamp,
  }) = _NoteDto;
  ...
  Note toDomain() {
    return Note(
      ...
      // serverTimeStamp: Timestamp.now().toDate(),
    );
  }
}

class SeverTimeStampConverter implements JsonConverter<FieldValue, Object> {
  const SeverTimeStampConverter();
