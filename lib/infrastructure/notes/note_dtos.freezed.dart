...
abstract class $NoteDtoCopyWith<$Res> {
  ...
  $Res call(
      ...
      @SeverTimeStampConverter() dynamic serverTimeStamp});
}
...
class _$_NoteDto extends _NoteDto {
  _$_NoteDto(
      ...
      @SeverTimeStampConverter() required this.serverTimeStamp})
      : _todos = todos,
        super._();
...
abstract class _NoteDto extends NoteDto {
  factory _NoteDto(
          ...
          required final List<TodoItemDto> todos,
          @SeverTimeStampConverter() required final dynamic serverTimeStamp}) =
      _$_NoteDto;
  _NoteDto._() : super._();
