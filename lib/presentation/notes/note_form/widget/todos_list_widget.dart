...
import 'package:firebase_ddd_note_app/presentation/notes/note_form/misc/build_context_x.dart';
        ...
        builder: (context, formTodos, child) {
          return ImplicitlyAnimatedReorderableList<TodoItemPrimitive>(
            ...
            onReorderFinished: (item, from, to, newItems) {
              ...
              context.read<NoteFormBloc>().add(NoteFormEvent.todosChange(context.formTodos));
            },
